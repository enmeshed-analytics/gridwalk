...
// TODO: Switch postgis_uri to enum to support other connectors
...
impl ConnectionInfo {
    pub async fn create_record<D: Database>(self, database: D) -> Result<()> {
...
impl GeospatialConfig {
    ...
    pub async fn get_connection(&self, name: &str) -> Result<Box<dyn GeoConnector>> {
